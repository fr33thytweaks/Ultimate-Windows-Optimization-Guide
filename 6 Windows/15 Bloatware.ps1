        ...
        switch ($choice) {
            ...
            2 {
                ...
                if ($OS.Caption -like '*Windows 11*') {
                    Get-AppXPackage -AllUsers *Microsoft.WindowsAppRuntime.CBS* | ForEach-Object { Add-AppxPackage -DisableDevelopmentMode -Register -ErrorAction SilentlyContinue "$($_.InstallLocation)\AppXManifest.xml" }
                }
                Clear-Host
